...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Question 1: Who is known as father of java programming language ?");  
            jb[0].setText("charles Babbage");jb[1].setText("James Gosling");jb[2].setText("M.P.Java");jb[3].setText("Blais Pascal");   
        }  
        if(current==1)  
        {  
            l.setText("Question 2 : IN WHICH YEAR JAVA WAS INTRODUCED ");  
            jb[0].setText("1985");jb[1].setText("1997");jb[2].setText("1995");jb[3].setText("2000");  
        }  
        if(current==2)  
        {  
        ...
        if(current==3)  
        {  
            l.setText("Question 4: during exception which block always gets executed ");  
        ...
        if(current==7)  
        {  
            l.setText("Question 8: What is the implict return type of constructor?");  
